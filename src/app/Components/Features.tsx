...
function Features() {
  return (
    <section className="flex items-center justify-center text-white py-16 px-6">
      <div className="max-w-4xl  text-center">
        <div className="text-base sm:text-base md:text-[30px]  lg:text-[42px] font-semibold leading-relaxed text-center flex flex-col md:gap-y-4 lg:gap-y-8 ">
